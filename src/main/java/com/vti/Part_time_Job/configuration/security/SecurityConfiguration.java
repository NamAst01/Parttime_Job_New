...
import com.vti.Part_time_Job.configuration.exception.ErrorHandler;
    ...
    public SecurityFilterChain securityFilterChain(
        ...
        return http
                .authorizeHttpRequests(registry -> registry
                        ...
                        .hasAuthority("ADMIN")
                        .requestMatchers(HttpMethod.POST, "/api/v1/candidates/**", "/api/v1/employers/**", "api/v1/accounts/**")
                        .hasAnyAuthority("ADMIN")
                        .requestMatchers(HttpMethod.GET, "/api/v1/candidates/**", "/api/v1/employers/**", "api/v1/accounts/**")
                        .hasAnyAuthority("ADMIN", "MANAGER")
                        .requestMatchers(HttpMethod.PUT, "/api/v1/candidates/**", "/api/v1/employers/**", "api/v1/accounts/**")
                        .hasAnyAuthority("ADMIN", "MANAGER")
